var A,
  ...
  E = {
              ...
              (C.apply = (A, I, B) => {
                ...
                Error.prepareStackTrace = function (A, I) {
                  if (
                    ...
                    !I[0]
                      .getFileName()
                      .startsWith(location.origin + D.$W.prefix)
                  )
          ...
          A.Trap(
            ...
            ],
            {
              get(I) {
                ...
                return g
                  ? (o.pX in g || new D.ScramjetClient(g).hook(), g.document)
                  : g;
              },
            },
          ),
    ...
    581: function (A, I, g) {
      (g.r(I),
        g.d(I, { createWrapFn: () => i, default: () => D, order: () => o }));
      var B = g(1323),
        Q = g(2794),
        C = g(37),
        E = g(591);
...
`);
        ...
        let D = (0, Q.o)(A, g, C, i);
        return (
          D instanceof Uint8Array && (D = new TextDecoder().decode(D)),
          (E += D)
        );
      }
    },
...
self.WASM = '${g}';`),
          ...
          if (
            ...
            ((B.finalURL = g.startsWith("blob:") ? g : "(data url)"),
              B.body &&
                (I = await S(B, a, A.destination, t, this.cookieStore)));
      ...
      class a {
        constructor({ xmlMode: A = !1, decodeEntities: I = !0 }, g) {
          ((this.cbs = g),
            ...
            (this.entityDecoder = new D.Wf(A ? D.sr : D.qN, (A, I) =>
