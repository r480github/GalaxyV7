var e,
  ...
  o = {
            ...
            for (t = i, a = !1; l(); )
              if ("," === (r = e.charAt(i))) {
                ...
                i < e.length && "=" === e.charAt(i)
                  ? ((a = !0), (i = s), o.push(e.substring(t, n)), (t = i))
                  : (i = n + 1);
              } else i += 1;
            (!a || i >= e.length) && o.push(e.substring(t, e.length));
          }
          return o;
        }));
    },
              ...
              (a.apply = function (e, t, n) {
                let s,
                  ...
                  o = {
                    ...
                    call: () => (
                      (a = !0),
                      (s = Reflect.apply(o.fn, o.this, o.args))
                    ),
                  },
        ...
        (e.Trap("Node.prototype.baseURI", {
          ...
          e.Proxy("Element.prototype.setAttributeNS", {
            apply(t) {
              ...
              o &&
                ((t.args[2] = o.fn(a, e.meta, e.cookieStore)),
                e.natives.call(
          ...
          e.Trap("Element.prototype.innerHTML", {
            set(r, n) {
              ...
              if (r.this instanceof t.HTMLScriptElement)
                ((i = (0, o.o)(n, "(anonymous script element)", e.meta)),
                  e.natives.call(
                    "Element.prototype.setAttribute",
                    r.this,
                    "scramjet-attr-script-source-src",
                    btoa(
                      Array.from(u.encode(i), (e) =>
                ...
                try {
                  i = (0, a.Qs)(n, e.cookieStore, e.meta);
                } catch {
                  i = n;
                }
              r.set(i);
          ...
          ["History.prototype.pushState", "History.prototype.replaceState"],
          {
            apply(t) {
              ...
              if (o.name === e.meta.topFrameName) {
                let t = new s.UrlChangeEvent(i.url.href);
      ...
      function g(e) {
        if (
          ...
          (t &&
            ...
            e.hook(),
            f && new i.ScramjetServiceWorkerRuntime(e).hook());
    ...
    3696: function (e, t, r) {
      ...
      function o(e, t) {
        ...
        for (let r of [
          ...
          let s = e.natives.call("Object.getOwnPropertyDescriptor", null, i, r);
          if (!s) continue;
          ...
          t.location.assign &&
            (o.assign = new Proxy(t.location.assign, {
              apply(r, a, o) {
                ...
                let i = new n.UrlChangeEvent(e.url.href);
    ...
    582: function (e, t, r) {
      (r.r(t), r.d(t, { argdbg: () => a, default: () => o, enabled: () => s }));
      var n = r(37);
    ...
    591: function (e, t, r) {
      (r.r(t), r.d(t, { default: () => a, indirectEval: () => o }));
      var n = r(37),
        s = r(1478);
      function a(e, t) {
        ...
        (Object.defineProperty(t, n.$W.globals.importfn, {
          value: function (t, n) {
            ...
            return n.includes(":") ||
              ...
              n.startsWith(".") ||
              n.startsWith("..")
              ? r(`return import("${(0, s.Oy)(a, e.meta)}?type=module")`)()
              : r(`return import("${n}")`)();
          },
          writable: !1,
          configurable: !1,
    ...
    6972: function (e, t, r) {
      ...
      function a(e) {
        (e.Proxy("fetch", {
          ...
          e.Trap("Response.prototype.url", { get: (e) => (0, s.v2)(e.get()) }),
          ...
          e.Proxy("WebSocketStream", {
            construct(r) {
              let s,
                ...
                o,
                i = {};
              (Object.setPrototypeOf(i, r.fn.prototype),
                (i.constructor = r.fn));
          ...
          e.Proxy("XMLHttpRequest.prototype.send", {
            apply(t) {
              ...
              let u = l.getUint16(1),
                d = l.getUint32(3),
                p = new Uint8Array(d);
              p.set(new Uint8Array(i.slice(7, 7 + d)));
              let h = new TextDecoder().decode(p),
                f = l.getUint32(7 + d),
                g = new Uint8Array(f);
              g.set(new Uint8Array(i.slice(11 + d, 11 + d + f)));
    ...
    7791: function (e, t, r) {
      ...
      var n = r(37),
        s = r(8665).A;
      let a = (e) => (0, n.U5)("sourcemaps", e.url);
      function o(e, t) {
          ...
          value: (t, r) => {
            ...
            (!(function (e, t, r) {
              ...
              for (let e = 0; e < i; e++) {
                ...
                l += 4;
                let r = s.getUint8(l);
                if (((l += 1), 0 == r)) o.push({ type: r, start: e, size: t });
                else if (1 == r) {
                  let i = e + t,
                    c = s.getUint32(l, !0);
                  l += 4;
                  let u = a.decode(n.subarray(l, l + c));
                  o.push({ type: r, start: e, end: i, str: u });
                }
              }
              ...
              (performance.now(),
                (function (e, t) {
                  ...
                  let p = c.slice(u, d),
                    ...
                    f = 0;
                  for (let e of p)
                    if (((h += r.slice(f, e.start - i)), 0 === e.type))
                      f = e.start + e.size - i;
                    else if (1 === e.type) ((h += e.str), (f = e.end - i));
                    else throw "unreachable";
                  ((h += r.slice(f)), t.return(h));
                })(e, t));
            },
          }));
      }
          ...
          ((0, n.Ec)(),
            ...
            navigator.serviceWorker.addEventListener("message", (e) => {
              ...
              "download" === t.scramjet$type &&
                this.dispatchEvent(
                  new a.ScramjetGlobalDownloadEvent(t.download),
                );
            }));
        }
        createFrame(e) {
    ...
    8083: function (e, t, r) {
      ...
      (r.d(t, { AL: () => a, HT: () => s, aR: () => n, q9: () => o }),
        (globalThis.$scramjetRequire = function (e) {
          return r(409)(e);
        }));
      let o = { build: "77fb2bc", version: "1.0.2-dev" };
      ((globalThis.$scramjetLoadController = n),
        (globalThis.$scramjetLoadClient = s),
        (globalThis.$scramjetLoadWorker = a),
        (globalThis.$scramjetVersion = o),
  ...
  `,
    ...
    37: function (e, t, r) {
      ...
      let d = Function;
      function p() {
        ((n = d(`return ${a.codec.encode}`)()),
          (s = d(`return ${a.codec.decode}`)()));
      }
      function h(e, t) {
        let r = a.flags[e];
      ...
      async function l(e, t, r, l) {
        ...
        if (
          ("string" == typeof c.link
            ? (c.link = i(c.link, t))
            : Array.isArray(c.link) && (c.link = c.link.map((e) => i(e, t))),
            ...
            if (
              ...
              (function e(t, r, n) {
                ...
                if (
                  ("style" === t.name &&
                    void 0 !== t.children[0] &&
                    (t.children[0].data = (0, i.s)(t.children[0].data, n)),
                  "script" === t.name &&
          ...
          try {
            ...
            ((i =
              "string" == typeof e
                ...
                : o.rewrite_js_bytes(e, r.base.href, t || "(unknown)", n)),
              a.time(r, l, `oxc rewrite for "${t || "(unknown)"}"`));
            let { js: c, map: u, scramtag: d, errors: p } = i;
            return {
...
${i}`;
    ...
    1472: function (e, t, r) {
      ...
      function l(e, t) {
        if (
          ...
          return "javascript:" + (0, s.o)(e.slice(11), "(javascript: url)", t);
        {
    ...
    1561: function (e, t, r) {
      ...
      n = Uint8Array.from(atob({}), (e) => e.charCodeAt(0));
...
`);
    ...
    6684: function (e, t, r) {
      ...
      async function c(e, t, r) {
        let n = await a(e);
        n && (await i(e), r && (n.referrerPolicy = r), await o(t, n));
      }
      ...
      async function p() {
        ...
        (await s())
          .transaction("redirectTrackers", "readwrite")
          .objectStore("redirectTrackers")
          .openCursor().onsuccess = (t) => {
          let r = t.target.result;
          r && (e - r.value.chainStarted > 36e5 && r.delete(), r.continue());
        };
      }
    ...
    8228: function (e, t, r) {
      ...
      async function o(e) {
        ...
        return new Promise((r, s) => {
          let a = t.put({ data: e, expiry: Date.now() + 36e5 }, n);
...
self.WASM = '${r}';`),
          ...
          let u = "",
            d = {};
          for (let [e, t] of [...i.searchParams.entries()]) {
            switch (e) {
              case "type":
                u = t;
                break;
              ...
              default:
                (f.warn(
                  `${i.href} extraneous query parameter ${e}. Assuming <form> element`,
                ),
                  (d[e] = t));
            }
            i.searchParams.delete(e);
          }
          let p = new URL((0, o.v2)(i));
          ...
          if (
            ...
            let t,
              r = i.pathname.substring(this.config.prefix.length);
          ...
          if (g?.connected && "swruntime" !== i.searchParams.get("from")) {
          ...
          if (
            ...
            if (t) {
              let e = new URL(t);
              v = await (0, s.ps)(h, e, this.client);
            }
          }
          (await (0, a.rj)(
            p.toString(),
            ...
            m.set("Sec-Fetch-Site", await (0, a.hU)(p.toString(), v)));
      ...
      async function y(e, t, r, n, i, l, d, p, h, f, m) {
        let y,
          S = "navigate" === i && ["document", "iframe"].includes(n),
          x = await (0, u.l)(l.rawHeaders, t, h, { get: a.Yq, set: a.pL });
        if (
          (S &&
            x["referrer-policy"] &&
            m &&
            (await (0, a.pL)(e.href, x["referrer-policy"], m)),
          g(l))
        ) {
          let t = new URL((0, o.v2)(x.location));
          await (0, a.YH)(e.toString(), t.toString(), x["referrer-policy"]);
          let n = await (0, s.ps)({ origin: t, base: t }, e, h);
        ...
        if (
          ...
          if ((0, c.U5)("interceptDownloads", e)) {
            ...
            if ((s = s.filter((e) => !e.url.includes(c.$W.prefix))).length < 1)
              throw Error(
    ...
    236: function (e, t, r) {
      ...
      function u(e) {
        ...
        return (
          i.call(e, { message: { type: "ping" }, port: t.port2 }, [t.port2]),
          r
        );
      }
      function d(e, t) {
          ...
          t &&
            o.addEventListener("message", (t) => {
              if ("getPort" === t.data.type && t.data.port) {
                ...
                let r = new s(e, "bare-mux-worker");
                i.call(t.data.port, r.port, [r.port]);
              }
            }),
          r.port
        );
      ...
      class h {
        ...
        async sendMessage(e, t) {
          ...
          return (i.call(this.port, { message: e, port: r.port2 }, n), await s);
        }
      }
                ...
                (e.ready || (await e.init()),
                  await (async function (e, t, r) {
                    ...
                    n.body instanceof ArrayBuffer
                      ? i.call(t, { type: "fetch", fetch: n }, [n.body])
                      : i.call(t, { type: "fetch", fetch: n });
                  })(n, r, e));
              } catch (e) {
                g(r, e, "fetch");
              }
    ...
    6072: function (e, t, r) {
      ...
      function h(e, t = !1) {
        ...
        else if (e.type === n.RJ.Comment) r = new i(e.data);
        else if ((0, n.dz)(e)) {
          let n = t ? f(e.children) : [],
            s = new p(e.name, { ...e.attribs }, n);
      ...
      function o(e) {
        ...
        for (; null !== (t = n.exec(e)); ) {
          let { index: i } = t,
            ...
            c = s.get(l);
          void 0 === c
            ? ((r += `${e.substring(o, i)}&#x${a(e, i).toString(16)};`),
              (o = n.lastIndex += Number((64512 & l) == 55296)))
            : ((r += e.substring(o, i) + c), (o = i + 1));
        }
        return r + e.substr(o);
      }
      function i(e, t) {
      ...
      class g {
        constructor(e, t = {}) {
          ...
          ((this.options = t),
            ...
            null == (l = (i = this.cbs).onparserinit) || l.call(i, this));
        }
        ontext(e, t) {
          var r, n;
        ...
        onclosetag(e, t) {
          ...
          if (
            ...
            this.htmlMode &&
              ...
              null == (i = (o = this.cbs).onopentag) || i.call(o, "br", {}, !0),
        ...
        oncomment(e, t, r) {
          ...
          ((this.endIndex = t),
            ...
            null == (o = (a = this.cbs).oncommentend) || o.call(a),
            (this.startIndex = t + 1));
        }
        oncdata(e, t, r) {
          var n, s, a, o, i, l, c, u, d, p;
          this.endIndex = t;
          let h = this.getSlice(e, t - r);
          (!this.htmlMode || this.options.recognizeCDATA
            ? (null == (s = (n = this.cbs).oncdatastart) || s.call(n),
              null == (o = (a = this.cbs).ontext) || o.call(a, h),
              null == (l = (i = this.cbs).oncdataend) || l.call(i))
      ...
      class h {
        ...
        stateBeforeDeclaration(e) {
          e === o.OpeningSquareBracket
            ...
            : (this.state = e === o.Dash ? i.BeforeComment : i.InDeclaration);
        }
      ...
      class b {
        ...
        rewrite_js(e, t, r, s) {
          let a = h(e, n.__wbindgen_malloc, n.__wbindgen_realloc),
            o = u,
            i = h(t, n.__wbindgen_malloc, n.__wbindgen_realloc),
            l = u,
            c = h(r, n.__wbindgen_malloc, n.__wbindgen_realloc),
            d = u,
            p = n.rewriter_rewrite_js(this.__wbg_ptr, a, o, i, l, c, d, s);
          if (p[2]) throw m(p[1]);
          return m(p[0]);
        }
        rewrite_js_bytes(e, t, r, s) {
          let a = (function (e, t) {
            ...
            i = h(t, n.__wbindgen_malloc, n.__wbindgen_realloc),
            c = u,
            d = h(r, n.__wbindgen_malloc, n.__wbindgen_realloc),
            p = u,
      ...
      function S() {
        ...
        return (
          ...
          (e.wbg.__wbg_scramtag_3a255d78b157986d = function (e) {
            let t = h((0, s.N)(), n.__wbindgen_malloc, n.__wbindgen_realloc),
              r = u;
          ...
          (e.wbg.__wbindgen_string_get = function (e, t) {
            ...
            var s =
                null == r ? 0 : h(r, n.__wbindgen_malloc, n.__wbindgen_realloc),
              a = u;
            (g().setInt32(e + 4, a, !0), g().setInt32(e + 0, s, !0));
          }),
...
export {
  ...
  k as ScramjetFrame,
  _ as ScramjetGlobalDownloadEvent,
  E as ScramjetHandleResponseEvent,
  T as ScramjetHeaders,
  A as ScramjetRequestEvent,
  C as ScramjetServiceWorker,
...
//# sourceMappingURL=polygon.bundle.js.map
