(() => {
	var e = {
				...
				function n(e, n) {
					var i,
						...
						c =
							...
							(s = ''),
							(o = ''),
							(a = i.split('=')).length > 1 ? ((s = a.shift()), (o = a.join('='))) : (o = i),
							{ name: s, value: o }),
						u = c.name,
						d = c.value;
							...
							? n.pX in e.parent
								...
								: n.pX in e.top
									...
									: e.opener && n.pX in e.opener
										...
										: (f.warn('Creating SingletonBox'), (this.box = new h.SingletonBox(this)))
							...
							(s.construct = function (e, t, n) {
								let i,
									...
									o = {
										...
										call: () => ((s = !0), (i = Reflect.construct(o.fn, o.args, o.newTarget)))
									};
								return (r.construct(o), s) ? i : Reflect.construct(o.fn, o.args, o.newTarget);
							}),
							r.apply &&
								(s.apply = function (e, t, n) {
									let i,
										...
										o = {
											...
											call: () => ((s = !0), (i = Reflect.apply(o.fn, o.this, o.args)))
										},
					...
					(e.Trap('Node.prototype.baseURI', {
						...
						e.Trap('Element.prototype.innerHTML', {
								...
								if (r.this instanceof t.HTMLScriptElement)
									((a = (0, o.o)(n, '(anonymous script element)', e.meta)),
										e.natives.call(
											...
											btoa(Array.from(u.encode(a), (e) => String.fromCodePoint(e)).join(''))
										));
								else if (r.this instanceof t.HTMLStyleElement) a = (0, i.s)(n, e.meta);
								else
									try {
							...
							get(r) {
								...
								return r.this instanceof t.HTMLStyleElement ? r.get() : (0, s.nK)(r.get());
							}
						}),
		...
		`)))
											...
											get(e, r, n) {
												...
												return r in t
													...
													: 'function' == typeof i
														? new Proxy(i, {
																apply: (e, t, r) =>
																	t === n ? Reflect.apply(e, o, r) : Reflect.apply(e, t, r)
															})
														: i;
											},
						...
						e.Proxy('WebSocketStream', {
							construct(r) {
								let i,
									...
									o,
									a = {};
								(Object.setPrototypeOf(a, r.fn.prototype), (a.constructor = r.fn));
							...
							apply(t) {
								(performance.now(),
									(function (e, t) {
										...
										if (!c) return (console.warn('failed to get rewrites for tag', i), t.return(r));
										let u = 0;
										for (; u < c.length; )
											if (c[u].start < a) u++;
											else break;
										...
										let h = c.slice(u, d),
											...
											f = 0;
										for (let e of h)
											if (((p += r.slice(f, e.start - a)), 0 === e.type)) f = e.start + e.size - a;
			...
			581: function (e, t, r) {
				(r.r(t), r.d(t, { createWrapFn: () => a, default: () => c, order: () => l }));
				var n = r(1323),
					i = r(2794),
					s = r(37),
					o = r(591);
  ...
  `,
					...
					getCookies(e, t) {
						...
						for (let s of n) {
							...
							(!s.secure || 'https:' === e.protocol) &&
								...
								(!s.domain.startsWith('.') || e.hostname.endsWith(s.domain.slice(1))) &&
								i.push(s);
						}
			...
			2393: function (e, t, r) {
				...
				let o = [
					...
					{
						fn: (e, t) => (e.startsWith('blob:') ? (0, s.$n)(e) : (0, s.Oy)(e, t)),
						src: ['video', 'audio']
					},
			...
			37: function (e, t, r) {
				...
				let o = Function;
				function a() {
					((n = o(`return ${s.codec.encode}`)()), (i = o(`return ${s.codec.decode}`)()));
				}
				function l(e, t) {
					let r = s.flags[e];
			...
			2614: function (e, t, r) {
				...
				function o(e, t, r) {
					return (t = (t = new String(t).toString()).replace(/url\(['"]?(.+?)['"]?\)/gm, (t, i) => {
						let s = 'rewrite' === e ? (0, n.Oy)(i.trim(), r) : (0, n.v2)(i.trim());
						...
						(t, i) =>
							t.replace(
								i,
								i.replace(/^(url\(['"]?|['"]|)(.+?)(['"]|['"]?\)|)$/gm, (t, i, s, o) => {
									if (i.startsWith('url')) return t;
									let a = 'rewrite' === e ? (0, n.Oy)(s.trim(), r) : (0, n.v2)(s.trim());
									return `${i}${a}${o}`;
								})
							)
					);
										...
										try {
											...
											if (r.imports)
												for (let e in r.imports) {
													let t = r.imports[e];
													'string' == typeof t && ((t = (0, o.Oy)(t, n)), (r.imports[e] = t));
												}
			...
			1472: function (e, t, r) {
				...
				function l(e, t) {
						...
						return 'javascript:' + (0, i.o)(e.slice(11), '(javascript: url)', t);
					{
						...
						return (
							(i.hash = ''),
							location.origin + n.$W.prefix + (0, n.hD)(i.href) + (o ? '#' + o : '')
						);
					}
				}
				function c(e) {
...
self.WASM = '${r}';`),
						...
						(await (0, s.rj)(h.toString(), e.referrer ? (0, o.v2)(e.referrer) : null, v),
				...
				async function y(e, t, r, n, a, l, d, h, p, f, m) {
					...
					if (
						(S && x['referrer-policy'] && m && (await (0, s.pL)(e.href, x['referrer-policy'], m)),
						g(l))
					) {
					...
					if (
						...
						if ((0, c.U5)('interceptDownloads', e)) {
							...
							(i[0].postMessage({ scramjet$type: 'download', download: s }, [l.body]),
								await new Promise(() => {}));
						} else {
				...
				async function b(e, t, r, n, i) {
					switch (r) {
						...
						case 'document':
							...
							return e.body;
						case 'script':
							return (0, a.o)(new Uint8Array(await e.arrayBuffer()), e.finalURL, t, 'module' === n);
						case 'style':
						...
						return new Promise((t, r) => {
							((e.onsuccess = async () => {
								let n = e.result
									...
									.get('config');
								((n.onsuccess = async () => {
									((this.config = n.result), (0, l.Nk)(n.result), await (0, o.n$)(), t());
								}),
									(n.onerror = () => r(n.error)));
							}),
								(e.onerror = () => r(e.error)));
			...
			236: function (e, t, r) {
				...
				function u(e) {
					...
					return (a.call(e, { message: { type: 'ping' }, port: t.port2 }, [t.port2]), r);
				}
				function d(e, t) {
		...
		`,
											...
											let [n, i] = r.connect(
												...
												(t) => {
													t instanceof ArrayBuffer
														? a.call(e.websocket.channel, { type: 'message', args: [t] }, [t])
														: a.call(e.websocket.channel, {
																type: 'message',
																args: [t]
															});
				...
				class S {
					...
					async fetch(e, t) {
						...
						for (let e = 0; ; e++) {
							...
							((i.rawHeaders = n.headers), (i.rawResponse = n), (i.finalURL = a.toString()));
			...
			9496: function () {},
			8466: function (e, t, r) {
				(r.d(t, { Gj: () => a.Gj, WY: () => a.WY, X1: () => a.X1 }), r(2990), r(466));
				var n,
					i,
					s,
					o,
					...
					stateInSelfClosingTag(e) {
						e === o.Gt
							? (this.cbs.onselfclosingtag(this.index),
								...
								(this.sectionStart = this.index + 1),
								(this.isSpecial = !1))
							: u(e) || ((this.state = a.BeforeAttributeName), this.stateBeforeAttributeName(e));
					}
			...
			3907: function (e, t, r) {
				...
				function p(e, t, r) {
					...
					if (o !== n) {
						(0 !== o && (e = e.slice(o)), (i = r(i, n, (n = o + 3 * e.length), 1) >>> 0));
...
//# sourceMappingURL=polygon.all.js.map
